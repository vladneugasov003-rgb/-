    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 400, padding: 24 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <div style={{
            width: 48, height: 48, borderRadius: 12, background: 'var(--c-purple)',
        ...
        <div className="card">
          <form onSubmit={submit}>
            ...
            <button type="submit" className="btn btn-primary" style={{ width: '100%', justifyContent: 'center', marginTop: 20, padding: '10px' }} disabled={loading}>
              {loading ? <span className="spinner" style={{ width: 16, height: 16 }} /> : mode === 'login' ? 'Войти' : 'Зарегистрироваться'}
            </button>
          </form>
        ...
        <p style={{ textAlign: 'center', fontSize: 12, color: 'var(--c-hint)', marginTop: 20 }}>
